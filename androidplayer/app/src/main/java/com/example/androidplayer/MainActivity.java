    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((SurfaceView) findViewById(R.id.surfaceView)).getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(@NonNull SurfaceHolder holder) {
                String inputPath = "/storage/emulated/0/Movies/1.mp4";
                String outputPath = "/path/to/output/video.mp4";
                Surface surface = holder.getSurface();

                new Thread(() -> {
                    Log.d("mainactivity", "执行播放");
                    processVideo(inputPath, outputPath, surface);
                }).start();
            }
        ...
        Log.d("Main", "surfaceCreated: 前运行到此···································");
...
//        });
    ...
    public native boolean processVideo(String inputPath, String outputPath, android.view.Surface surface);
}